...
def should_skip_position(example: dict[str, Any], include_mates: bool = True, max_mate_distance: int = 15, max_cp: int = 750) -> bool:
    """
...
def process_dataset_batch(dataset_stream: Any, num_samples: int, max_mate_distance: int = 15, max_cp: int = 750) -> tuple[pd.DataFrame, dict[str, int]]:
    """
